...
const OrdersTable = ({user}) => {
    ...
    const getAllOrdersList = async () => {
        ...
        return setAllOrders(ordersList);
    };
    ...
    // setInterval(async() => await getOrdersList(), 20000)
                                ...
                                <td align="center">
                                    {order.status === "succeeded" ? "Оплачен" :
                                     <>
                                        Не оплачен
                                        <br />
                                        <Button variant="outline-secondary" onClick={() => checkout(order)}>
                                            Оплатить
                                        </Button>
                                    </>
                                    }
